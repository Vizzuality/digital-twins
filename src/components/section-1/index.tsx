...
export default function Section1() {
  ...
  return (
    <section className="relative bg-white py-20 scroll-mt-8" id="section-1">
      <Lines verticalClassName="pl-[152px] pr-[152px]" sectionName="section-1" rows={[474, (!hoveredIndex || hoveredIndex === 0) ? 1108 : 1136]} colorClass="bg-blue-900/20" hoveringColumnsNumber={3} hoveredIndex={hoveredIndex} />
