...
export default function Intro() {
  return (<section className="relative h-screen bg-blue-900 pt-[90px]">
    ...
    <Button variant="white">
      ...
      <ArrowRightIcon className="w-5 h-5 hover:text-red-300" />
    </Button>
    ...
    <video autoPlay loop muted playsInline className="absolute bottom-0 w-full h-[480px] object-cover mix-blend-screen opacity-50">
