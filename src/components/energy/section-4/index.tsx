...
export default function Section4() {
  ...
  const variants: Record<string, Variants> = {
    ...
    'step-2': {
      animate: {
        opacity: 1, width: 0, left: '10%', textAlign: 'left', top: '10%', whiteSpace: 'nowrap', transition: { ...transition, left: { duration: 0.1 } }
      },
    },
    'step-3': {
      animate: { opacity: 1, width: 0, left: '10%', textAlign: 'left', top: '10%', whiteSpace: 'nowrap', transition },
    }
  };
  ...
  const legend = <div className="h-8 py-1 flex-col gap-1 inline-flex text-2xs">
  ...
  return (
    <section className="relative bg-green-800" id="section-4">
        ...
        <div className='sticky h-[100vh] w-full flex justify-center inset-0' id="globe-phase-1">
          ...
          >
            <AnimatePresence>
              {step !== 'step-3' && <motion.div
                ...
                <div className="text-xl xl:text-4xl max-w-[90vw] xl:max-w-[720px] mx-auto">
          ...
          <AnimatePresence>
            ...
            {step !== 'step-1' && <motion.div
              ...
              className="absolute bg-white/30 h-px w-full"
            ...
            {step !== 'step-1' && <motion.div
              ...
              className="absolute bg-white/30 w-px h-full top-0"
          ...
          {step !== 'step-1' && <motion.div
            ...
            className="absolute bottom-0 w-full text-white max-w-[459px] left-[60%]"
          >
            <AnimatePresence>
          ...
          <AnimatePresence>
            {step === 'step-3' && <div>
              <motion.div
                className="text-white absolute top-[30%] left-[10%] w-full"
                initial={{ opacity: 0, top: 'calc(30% + 200px)' }}
                animate={{ opacity: 1, top: '30%', transition }}
                exit={{ opacity: 0, top: 'calc(30% + 200px)' }}
              >
                <div className="relative">
                  <Chart className="max-w-[47%]" />
                  <motion.svg
                    width="708"
                    height="305"
                    viewBox="0 0 708 305"
                    className="absolute top-0 left-0 max-w-[47%]"
