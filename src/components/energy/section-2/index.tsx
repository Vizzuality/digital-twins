  ...
  return (
    <section className="relative bg-green-200 text-green-700" id="section-2">
      ...
      >
        ...
        />
        <div
          className="sticky inset-0 flex h-[100vh] w-full flex-col-reverse items-center justify-center xl:flex-row xl:gap-[94px]"
          id="section-2-step-1"
        >
          <div
          ...
          <div className="flex w-full flex-col max-xl:container max-xl:max-h-[60vh] max-xl:pt-10 xl:h-full xl:w-1/2 xl:justify-center">
            <AnimatePresence>
              {step !== "section-2-step-2" ? (
                <motion.div
