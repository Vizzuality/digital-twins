      ...
      <div className="container relative z-10 xl:px-[150px]">
        ...
        <div className={cn("mt-6 grid text-green-700 xl:mt-0")}>
          <div className={cn(gridColumns)}>
            <FadeIn delay={0.2}>
              <h3 className="col-span-1 mb-4 text-lg xl:mb-0 xl:max-w-[300px] xl:pr-10 xl:text-xl">
              ...
              <div className="col-start-2">
                <div className="flex flex-col gap-2 xl:gap-4 xl:pr-10">
                  <div className="flex flex-col">
                    ...
                    <div className="leading-relaxed xl:max-w-[300px] xl:text-lg">
                      Real-time access to capacity factor data:
                    </div>
                  </div>
                  <div className="text-sm leading-tight xl:max-w-[300px] xl:text-xs">
