...
const HeroVideo = () => {
  ...
  return (
    <VideoPlayer
      src={"/videos/stream-videos/hero/index.m3u8"}
      onTimeUpdate={handleProgress}
      className="absolute bottom-0 z-0 w-full transform object-cover opacity-50 mix-blend-screen transition-opacity duration-2000 ease-in-out"
    />
  );
};
